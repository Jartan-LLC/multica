...
func (h *Handler) CreateAgent(w http.ResponseWriter, r *http.Request) {
	...
	// JAR-571 §2/§3/§4). Two different rules, and the difference is the point:
	//
	...
	if definitionActor.isAgent() {
		// Jartan fork (JAR-571 §4): the server sets the trust axis for a seat
...
func (h *Handler) UpdateAgent(w http.ResponseWriter, r *http.Request) {
	...
	// Field scope for an allow-listed agent principal (Jartan fork, JAR-571
	// §2/§3): instructions, model, thinking_level, name, description — and
	...
	if permissionTouched {
		// Jartan fork (SEC-2026-0069): an agent principal never reaches this
...
func (h *Handler) CancelAgentTasks(w http.ResponseWriter, r *http.Request) {
	...
	// Closed to agent principals (Jartan fork, JAR-571 §2): cancelling another
