...
func (h *Handler) CreateChatSession(w http.ResponseWriter, r *http.Request) {
	...
	session, err := qtx.CreateChatSession(r.Context(), db.CreateChatSessionParams{
		...
		Title:       req.Title,
		ProjectID:   projectID,
		// Jartan fork (SEC-2026-0078): record WHICH principal created this
...
func (h *Handler) ListChatSessions(w http.ResponseWriter, r *http.Request) {
	...
	// Jartan fork (SEC-2026-0078): the creator_id predicate in the queries below
...
func (h *Handler) loadChatSessionForUser(w http.ResponseWriter, r *http.Request, userID, workspaceID, sessionID string) (db.ChatSession, bool) {
	...
	// Jartan fork (SEC-2026-0078): the creator check above separates nobody
...
func (h *Handler) SendChatMessage(w http.ResponseWriter, r *http.Request) {
	...
	// invoke gate.
	//
	// Jartan fork (SEC-2026-0079): the sending run's task id rides along, so an
...
func (h *Handler) ListPendingChatTasks(w http.ResponseWriter, r *http.Request) {
	...
	// Jartan fork (SEC-2026-0078): same principal scope as ListChatSessions —
...
func (h *Handler) HasPendingChatTasks(w http.ResponseWriter, r *http.Request) {
	...
	// Jartan fork (SEC-2026-0078): HasPendingChatTasksByCreator is an EXISTS
...
type ChatSessionResponse struct {
	...
	// a human created it (Jartan fork, SEC-2026-0078). Additive: an upstream
